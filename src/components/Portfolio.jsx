        ...
        <div id="work" className="mt-10 relative">
            ...
            <Div className="mb-10">
                ...
                <div className="text-[16px] 2xl:text-[20px] leading-[24px] 2xl:leading-[32px] text-[#CCCCCC] text-center">
                    The Projects I've Created Recently
                </div>
            </Div>
            {/* SECTION HEADING END */}
                ...
                {projectData.map((item, index) => {
                    return (
                        ...
                        >
                            ...
                            <div className="bg-black rounded-[20px] aspect-video overflow-hidden transition-all duration-500 ease-linear hover:scale-105">
                                <img
                                    src={item.image}
                                    className={`transition-transform ${item.noScroll ?  'hover:-translate-y-[15%] hover:duration-500' : 'hover:-translate-y-[50%]'}  hover:duration-2500 ease-linear`}
                                />
                            </div>
