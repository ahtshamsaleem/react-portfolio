    ...
    return (
        ...
        >
            ...
            <Wrapper>
                ...
                {/* BIG HEADING START */}
                <motion.div
                    className="flex  justify-center text-center mt-14 mb-4 relative"
                ...
                >
                    <div className="font-light mb-4">
                        👋 Hi, I Am{" "}
                        <span className="font-semibold">Ihtisham Ul Haq</span>
                    </div>
                    <div className="max-w-[510px]">
                        I'm a reactJs developer, passionate to build stunning and modern websites.
                ...
                >
                    ...
                    <div
                        className=" customCss-btn-hireme absolute top-[140px] z-50 -right-10 2xl:top-[240px] 2xl:-right-10 w-[140px] h-[140px] rounded-full bg-white/[0.7] flex flex-col justify-center items-center gap-2 backdrop-blur-sm cursor-pointer transition-transform scale-[0.65] md:scale-100 active:scale-[0.55] md:active:scale-90"
                        onClick={() => scrollTo("contact")}
                    >
                        <img
                    ...
                    <img src={man} alt=""  className="customCss-img"/>
                    {/* HIRE ME BUTTON END */}
                </motion.div>
                {/* PERSON BLOCK END */}
            </Wrapper>
